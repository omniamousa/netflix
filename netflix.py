...
#C) The listed_in column includes multiple genres separated by commas.1- Extract and count the frequency of each genre individually.2- Display the top 10 most common genres across all titles.
...
# D) Identify all TV Shows:Added to Netflix in 2019 or later.With a rating of 'TV-MA'.That are from the United States.Belong to the 'International TV Shows' genre in the listed_in column.Return the title, country, rating, date_added, and listed_in.
